// Compile (MSYS2)      : $ g++ -std=c++14 -I"C:\Users\RJW\vcpkg\packages\libpcap_x64-windows\include" -L"C:\Users\RJW\vcpkg\packages\libpcap_x64-windows\lib" -o TimeStarter ./TimeStarter.cpp -lpcap -O2
// Run     (Terminal) : ./TimeStarter ..\md/md-cfe-tsp05-eth7-d-2024-41-ok.pcap
...
int main(int argc, char* argv[]) {
    ...
    cout << "Total Time taken to process messages: " << duration_cast<milliseconds>(duration_process).count() << " ms " << endl << endl;
